    ...
    <main className="min-h-screen px-4 sm:px-8 pt-10 pb-20">
      <div className="max-w-2xl mx-auto">
        <div className="flex items-center gap-3 mb-8">
          ...
          <div>
            <h1 className="text-xl font-black text-white">Yeni İndikatör</h1>
            <p className="text-slate-500 text-xs mt-0.5">Yeni bir indikatör ekle.</p>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="pt-2">
            <button type="submit" disabled={saving}
              ...
              {saving ? "Kaydediliyor..." : "İndikatörü Kaydet"}
            </button>
          </div>
        </form>
      </div>
