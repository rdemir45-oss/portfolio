...
export default function IndicatorsClient({ indicators }: { indicators: IndicatorItem[] }) {
          ...
          {indicators.map((ind, i) => (
            ...
            >
              <Link
                ...
                className="group relative flex flex-col h-full bg-[#0a1628]/80 border border-slate-800 rounded-2xl overflow-hidden hover:border-emerald-700/70 transition-all hover:shadow-lg hover:shadow-emerald-950/30 cursor-pointer"
              >
                {/* Cover Image */}
                {ind.cover_image && (
